...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{../report/assets/P2-4-1.png}
    \caption{CartPole-v1}
    \label{fig:q1_cartpole}
\end{figure}
...
\MYSOLUTION This figure will be shown in question 2.5. 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{../report/assets/P2-4-3-2.png}
    \includegraphics[width=0.4\textwidth]{../report/assets/P2-4-3-3.png}
    \includegraphics[width=0.4\textwidth]{../report/assets/P2-4-3-1.png}
    \caption{CartPole-v1 with learning rate 0.05 and 1e-3}
    \label{fig:q1_cartpole_lr}
\end{figure}

The predicted Q values are larger when the learning rate is bigger (0.05). This may due to the fact that the updating speed of the target is faster, so there will be more bias. The critic loss is larger and more unstable when the learning rate is bigger. This is because the target is moving too quickly, and the model is not able to converge.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../report/assets/P2-5.png}
    \caption{LunarLander-v2 with double Q learning}
    \label{fig:q1_lunarlander}
\end{figure}
...
\MYSOLUTION I choose the learning rate for the hyperparameter. The results is shown below:

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../report/assets/P2-6.png}
    \caption{CartPole-v1 with different learning rates}
    \label{fig:q1_hyperparameter}
\end{figure}
